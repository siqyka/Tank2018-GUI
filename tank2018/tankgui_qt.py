...
class Tank2018(QWidget):
    ...
    def login_gui(self):
        ...
        palette1.setBrush(self.backgroundRole(), QtGui.QBrush(QtGui.QPixmap('LOGO.png')))  
        ...
        self.label3.setText(_translate("self", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#474b53;\">或需要以下操作 </span></p></body></html>"))
    ...
    def login(self):
        ...
        self.close()
        self.another = personal.Tank2018_2()
        self.another.show()
